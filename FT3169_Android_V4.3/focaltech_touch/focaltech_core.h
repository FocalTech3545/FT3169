...
#define FTS_DRM_PANEL_NOTIFY 1
#else
#define FTS_MSM_DRM_PANEL_NOTIFY 1
#endif
#elif IS_ENABLED(CONFIG_FB)
#define FTS_FB_NOTIFY 1
#endif
#else
#if IS_ENABLED(CONFIG_QCOM_PANEL_EVENT_NOTIFIER)
#define FTS_QCOM_PANEL_EVENT_NOTIFY 1
#elif IS_ENABLED(CONFIG_FB)
#define FTS_FB_NOTIFY 1
#endif
#endif
...
int fts_input_report_touch(struct fts_ts_data *ts_data, struct ts_event *events);
#if FTS_PEN_EN
int fts_input_report_pen(struct fts_ts_data *ts_data, struct pen_event *pevt);
#endif
